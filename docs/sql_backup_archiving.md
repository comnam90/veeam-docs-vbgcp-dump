...
[![Enabling Backup Archiving](images/sql_backup_archiving_repo.webp)](images/sql_backup_archiving_repo.webp "Enabling Backup Archiving")
...
[![Enabling Backup Archiving](images/sql_backup_archiving_weekly.webp)](images/sql_backup_archiving_weekly.webp "Enabling Backup Archiving")
...
[![Enabling Backup Archiving](images/sql_backup_archiving_monthly.webp)](images/sql_backup_archiving_monthly.webp "Enabling Backup Archiving")
...
For more information on how Veeam Backup for Google Cloud transforms regular backup chains, see [Retention Policy for Backups](backup_retention_sql.md).
...
For more information on how Veeam Backup for Google Cloud transforms archive backup chains, see [Retention Policy for Archived Backups](archive_backup_retention_sql.md).
