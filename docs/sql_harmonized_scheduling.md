...
product: "vbgcp"
doc_type: "guide"
source_url: "https://helpcenter.veeam.com/docs/vbgc/guide/sql_harmonized_scheduling.html"
...
| --- |
| Note |
| Restore points created according to a more-frequent schedule and less-frequent schedules compose a single backup or snapshot chain. This means that regardless of flags assigned to restore points, Veeam Backup for Google Cloud adds the restore points to the chain as described in sections [Backup Chain](backup_chain_sql.md) and [Snapshot Chain](snapshot_chain_sql.md). |
...
[![Enabling Harmonized Scheduling](images/sql_harmonized_scheduling_daily.webp)](images/sql_harmonized_scheduling_daily.webp "Enabling Harmonized Scheduling")
...
[![Enabling Harmonized Scheduling](images/sql_harmonized_scheduling_weekly.webp)](images/sql_harmonized_scheduling_weekly.webp "Enabling Harmonized Scheduling")
...
![Enabling Harmonized Scheduling](images/sql_retention_snapshots_daily_weekly.webp)
...
![Enabling Harmonized Scheduling](images/sql_retention_snapshots_daily_removed.webp)
...
![Enabling Harmonized Scheduling](images/sql_retention_snapshots_daily_rp_removed.webp)
