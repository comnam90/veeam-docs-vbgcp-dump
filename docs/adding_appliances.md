...
* [Deploy new Veeam Backup for Google Cloud appliances](deploying_appliance.md) from the Veeam Backup & Replication console.
* [Connect to existing Veeam Backup for Google Cloud appliances](connecting_existing_appliance.md) if you have already deployed them.
