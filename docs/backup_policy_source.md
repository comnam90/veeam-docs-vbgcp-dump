...
product: "vbgcp"
doc_type: "guide"
source_url: "https://helpcenter.veeam.com/docs/vbgc/guide/backup_policy_source.html"
...
At the Resources step of the wizard, select the regions where VM instances that you plan to back up reside, choose VM instances to back up, and specify VM instances or labels to exclude from the backup policy.
...
[![Adding Backup Policy](images/policy_regions.webp)](images/policy_regions.webp "Adding Backup Policy")
...
2. In the Choose resources window, choose whether you want to back up all VM instances from the regions selected in the previous section of this step, or only specific VM instances.
