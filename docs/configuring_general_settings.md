...
* [Provide certificates to secure connections between Veeam Backup for Google Cloud architecture components](replacing_security_certificates.md).
* [Configure notification settings for automated delivery of reports](configuring_global_notification_settings.md).
