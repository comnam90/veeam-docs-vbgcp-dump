---
title: "sql_restore_service_account"
source_url: "https://helpcenter.veeam.com/docs/vbgc/guide/sql_restore_service_account.html"
...
At the Service Account step of the wizard, select a service account whose permissions will be used to perform the restore operation. For more information on the required permissions, see [Service Account Permissions](restore_permissions.md#sql).
...
[![Restoring Cloud SQL Instance](images/sql_restore_service_acc.webp)](images/sql_restore_service_acc.webp "Restoring Cloud SQL Instance")
