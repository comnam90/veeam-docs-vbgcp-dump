---
title: "backup_policy_project"
source_url: "https://helpcenter.veeam.com/docs/vbgc/guide/backup_policy_project.html"
...
For a service account to be displayed in the list of available accounts, it must be added to Veeam Backup for Google Cloud as described in section [Adding Service Accounts](adding_service_accounts.md), and must be assigned the VM Instances Snapshot and Backup operational roles as described in section [Adding Projects and Folders](adding_projects.md).

[![Adding Backup Policy](images/policy_project.webp)](images/policy_project.webp "Adding Backup Policy")
