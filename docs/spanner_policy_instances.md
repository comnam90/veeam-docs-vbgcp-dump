---
title: "Step 4b. Select Cloud Spanner Instances"
product: "vbgcp"
doc_type: "guide"
...
2. In the Choose resources window, choose whether you want to back up all Cloud Spanner instances from the regions selected at [step 4a](spanner_policy_regions.md), or only specific Cloud Spanner instances.
...
1. Use the Resource type drop-down list to choose whether you want to add individual Cloud Spanner instances or Google Cloud labels to the backup scope.
...
[![Adding Backup Policy](images/spanner_policy_instances.webp)](images/spanner_policy_instances.webp "Adding Backup Policy")
