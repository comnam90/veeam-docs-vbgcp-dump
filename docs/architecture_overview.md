...
* [Veeam Plug-in for Google Cloud](google_plugin.md)
...
[![Add backup policy](images/backup_infrastructure.webp)](images/backup_infrastructure.webp "Add backup policy")
