...
| --- |
| Note |
| Restore points created according to a more-frequent schedule and less-frequent schedules compose a single backup or snapshot chain. This means that regardless of flags assigned to restore points, Veeam Backup for Google Cloud adds the restore points to the chain as described in sections [Backup Chain](backup_chain_spanner.md) and [Snapshot Chain](snapshot_chain_spanner.md). |
...
[![Enabling Harmonized Scheduling](images/spanner_harmonized_scheduling_daily.webp)](images/spanner_harmonized_scheduling_daily.webp "Enabling Harmonized Scheduling")
...
[![Enabling Harmonized Scheduling](images/spanner_harmonized_scheduling_weekly.webp)](images/spanner_harmonized_scheduling_weekly.webp "Enabling Harmonized Scheduling")
